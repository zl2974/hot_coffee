...
1. Chi-Squared test between violation counts generated in each weekdays and different boroughs
...
b) test whether the the probability of falling in the each hour is the same for each borough:
