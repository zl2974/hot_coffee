...
a) Chi-Squared test between violation counts generated in each weekdays and different boroughs
...
b)  Chi-Squared test between violation counts generated in each hour and different boroughs:
...
```{r}
fit1 = 
  lm(violation_number ~ borough + factor(workday_weekend) + factor(daytime) + factor(month), data = boro_daytime_violation) 
...
brief notes for how to analysis this regression result:  
1. stay at home order since March to June 8th.  
2. [alternate side parking regulations](https://patch.com/new-york/midtown-nyc/nyc-extends-alternate-side-parking-suspension)
   [regulation] (https://www1.nyc.gov/html/dot/html/pr2020/pr20-037.shtml)    
3. Pandemic becomes worse since OCT. The second Covid-19 outbreak happened all over the U.S. since Oct   
4. [free parking on major Legal Holidays and Sundays:](https://newyorkparkingticket.com/parking-rules-holidays-sundays/). This explain why p-value of “factor(daytime)1” is below 0.05. That means workday factor is significant. Comparing with weekend, there are more parking violation on workdays than weenend due to NYC free parking rules on Sunday.  
5. Junly and August are usually summer holiday for students all over the world. Due to that NYC is a tourist attraction, the number of tourists should be increased in July and August. Tourists who aren't familiar with the NYC parking rules may easily receive parking tickets.
3. Pandemic becomes worse since OCT. The second Covid-19 outbreak happened all over the U.S. since Oct 
4. [free parking on major Legal Holidays and Sundays:](https://newyorkparkingticket.com/parking-rules-holidays-sundays/). This explain why p-value of “factor(daytime)1” is below 0.05. That means workday factor is significant. Comparing with weekend, there are more parking violation on workdays than weenend due to NYC free parking rules on Sunday.
>>>>>>> 214a846450c6b27ddbc8c5c0751f20cb6187d99b
