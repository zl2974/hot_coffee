...
### Some thought about how to study the correlation of tickets and cafe.
...
- some special case:
-- new york is not a square
-- if N tickets and M cafe are in the same box: modify the correlation coefficient?
