...
parking %>% 
  ...
  labs(
    x = 'Issuing Month',
    y = 'count',
    title = 'The distribution of tickets quantities over time '
  )
 
```

Conclusion: This dataset has nearly 39 million observations, most of which are recorded during June, July, August, and October.  
